                            ...
                            <template v-if="item">
                                {% block heptacom_admin_open_auth_client_edit_page_content_actions_inner %}
                                    ...
                                    <heptacom-admin-open-auth-client-rule-container
                                        v-if="actions[actionTab] !== undefined"
                                        :client="item"
                                        :action="actions[actionTab]"
...
`});var Fe={};a(Fe,{default:()=>Zt});var Zt,Re=o(()=>{$e();Zt={template:Pe,props:{item:{required:!0}}}});var qe,Ue=o(()=>{qe=`{% block heptacom_admin_open_auth_provider_jumpcloud_settings %}
    ...
    {% endblock %}
{% endblock %}
`});var Me={};a(Me,{default:()=>Yt});var Yt,Le=o(()=>{Ue();Yt={template:qe,props:{item:{required:!0}},data(){return{availableProperties:["firstName","lastName","email","timezone","locale","roles"]}},watch:{item(e){e.config.attributeMapping||(e.config.attributeMapping={})}}}});var De,Te=o(()=>{De=`{% block heptacom_admin_open_auth_provider_keycloak_settings %}
