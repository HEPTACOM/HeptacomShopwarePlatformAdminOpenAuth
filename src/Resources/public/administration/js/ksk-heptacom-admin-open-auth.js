(()=>{var st=Object.defineProperty;var o=(e,t)=>()=>(e&&(t=e(e=0)),t);var n=(e,t)=>{for(var i in t)st(e,i,{get:t[i],enumerable:!0})};var y=o(()=>{});var C,k=o(()=>{C=`{% block heptacom_admin_open_auth_scope_field %}
...
{% endblock %}
`});var ge={};n(ge,{default:()=>It});var It,fe=o(()=>{ue();It={template:_e,props:{item:{required:!0}},watch:{item(e){e.config.scopes||(e.config.scopes=[])}}}});var be,ve=o(()=>{be=`{% block heptacom_admin_open_auth_client_google_cloud_settings %}
...
{% endblock %}
`});var we={};n(we,{default:()=>Nt});var Nt,Ae=o(()=>{ve();Nt={template:be,props:{item:{required:!0}},watch:{item(e){e.config.scopes||(e.config.scopes=[])}}}});var ke,ye=o(()=>{ke=`{% block heptacom_admin_open_auth_provider_jira_settings %}
...
{% endblock %}
`});var Ce={};n(Ce,{default:()=>jt});var jt,xe=o(()=>{ye();jt={template:ke,props:{item:{required:!0}}}});var $e,Oe=o(()=>{$e=`{% block heptacom_admin_open_auth_provider_jumpcloud_settings %}
    ...
    {% endblock %}
{% endblock %}
`});var Se={};n(Se,{default:()=>Bt});var Bt,Pe=o(()=>{Oe();Bt={template:$e,props:{item:{required:!0}},data(){return{availableProperties:["firstName","lastName","email","timezone","locale","roles"]}},watch:{item(e){e.config.attributeMapping||(e.config.attributeMapping={})}}}});var Re,Fe=o(()=>{Re=`{% block heptacom_admin_open_auth_provider_keycloak_settings %}
...
{% endblock %}
`});var De={};n(De,{default:()=>Gt});var Gt,Te=o(()=>{qe();Gt={template:Le,props:{item:{required:!0}},watch:{item(e){e.config.scopes||(e.config.scopes=[])}}}});var He,Ie=o(()=>{He=`{% block heptacom_admin_open_auth_provider_okta_settings %}
...
{% endblock %}
`});var Ne={};n(Ne,{default:()=>Wt});var Wt,Ee=o(()=>{Ie();Wt={template:He,props:{item:{required:!0}},watch:{item(e){e.config.scopes||(e.config.scopes=[])}}}});var ze,je=o(()=>{ze=`{% block heptacom_admin_open_auth_provider_onelogin_settings %}
...
{% endblock %}
`});var Be={};n(Be,{default:()=>Qt});var Qt,Ke=o(()=>{je();Qt={template:ze,props:{item:{required:!0}},watch:{item(e){e.config.scopes||(e.config.scopes=[])}}}});var Je,Xe=o(()=>{Je=`{% block sw_condition_value_content %}
...
{% endblock %}
`});var Ye={};n(Ye,{default:()=>ai});var ai,et=o(()=>{Ze();ai={template:Qe,props:{item:{required:!0}},watch:{item(e){e.config.scopes||(e.config.scopes=[])}}}});var it,tt=o(()=>{it=`{% block heptacom_admin_open_auth_provider_saml2_settings %}
    <div>
