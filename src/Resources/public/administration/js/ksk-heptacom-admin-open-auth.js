...
{% endblock %}
`});var De={};a(De,{default:()=>Gt});var Gt,Te=o(()=>{Me();Gt={template:Le,props:{item:{required:!0}},watch:{item(e){e.config.scopes||(e.config.scopes=[])}}}});var He,Ie=o(()=>{He=`{% block heptacom_admin_open_auth_provider_okta_settings %}
