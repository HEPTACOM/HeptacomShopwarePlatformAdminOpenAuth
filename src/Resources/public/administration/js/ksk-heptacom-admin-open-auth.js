...
`});var P={};n(P,{default:()=>ht});var fi,h,S,ht,F=o(()=>{O();x();({Component:fi,Context:h}=Shopware),S="HeptacomAdminOpenAuthConfirmState",ht={template:$,inject:["loginService","repositoryFactory"],props:{divider:{type:Boolean,default:!0}},data(){return{loading:!0,clients:[],waitingForConfirmation:!1,confirmationClient:null,popupsAreBlocked:null}},computed:{heptacomAdminOpenAuthClientsRepository(){return this.repositoryFactory.create("heptacom_admin_open_auth_client")},httpClient(){return this.heptacomAdminOpenAuthClientsRepository.httpClient},sectionDivider(){return this.divider?"bottom":""}},created(){this.createdComponent()},methods:{createdComponent(){this.loadClients()},loadClients(){this.loading=!0,this.clients=[],this.getConnectedClients().then(e=>{this.clients=e}).finally(()=>{this.loading=!1})},startAuthFlow(e){let t=this;this.waitingForConfirmation=!0,this.popupsAreBlocked=null,this.confirmationClient=e,localStorage.removeItem(S),this.getConfirmRedirectUrl(e.id).then(i=>{let a=Math.floor((screen.width-600)/2),r=Math.floor((screen.height-600)/2),s=window.open(i,this.$t("heptacom-admin-open-auth-user-confirm-login.confirmWith",{clientName:e.name}),`location=0,status=0,width=600,height=600, top=${r}, left=${a}`),d=null,_=window.setTimeout(()=>{(!s||s.closed||typeof s.closed>"u")&&(t.popupsAreBlocked=!0,t.waitingForConfirmation=!1,d&&window.clearInterval(d))},1200);try{s.focus(),t.popupsAreBlocked=!1}catch{t.popupsAreBlocked=!0,t.waitingForConfirmation=!1,window.clearTimeout(_);return}d=window.setInterval(()=>{if(!this.waitingForConfirmation){window.clearInterval(d),window.clearTimeout(_),this.popupsAreBlocked=!1,s.close();return}if(s.closed){window.clearInterval(d),window.clearTimeout(_),this.popupsAreBlocked=!1,this.waitingForConfirmation=!1;let g=localStorage.getItem(S);g&&this.verifyByState(JSON.parse(g).state)}},1e3)})},abortAuthFlow(){this.confirmationClient=null,this.waitingForConfirmation=!1},getConnectedClients(){let e=this.heptacomAdminOpenAuthClientsRepository.buildHeaders(h.api);return this.httpClient.get("/_admin/open-auth/client/list",{headers:e}).then(t=>t.data.data.filter(i=>i.connected))},getConfirmRedirectUrl(e){let t=this.heptacomAdminOpenAuthClientsRepository.buildHeaders(h.api);return this.httpClient.get(`/_admin/open-auth/${e}/confirm`,{headers:t}).then(i=>i.data.target)},verifyByState(e){this.httpClient.post("/oauth/token",{grant_type:"heptacom_admin_open_auth_one_time_token",client_id:"administration",scope:"user-verified",one_time_token:e},{baseURL:h.api.apiPath}).then(t=>{let i={...h.api};i.authToken.access=t.data.access_token;let a={...this.loginService.getBearerAuthentication(),access:i.authToken.access};this.loginService.setBearerAuthentication(a),this.$emit("confirm",i)})}}}});var L,M=o(()=>{L=`{% block heptacom_admin_open_auth_role_assignment_action_config %}
    ...
    ></sw-entity-multi-id-select>
{% endblock %}
`});var T={};n(T,{default:()=>bt});var bt,D=o(()=>{M();bt={template:L,inject:["repositoryFactory"],props:{client:{required:!0,type:Object},rule:{required:!0,type:Object}},computed:{aclRoleRepository(){return this.repositoryFactory.create("acl_role")}}}});var H,I=o(()=>{H=`{% block heptacom_admin_open_auth_client_rule_container %}
    <div>
...
{% endblock %}
`});var Oe={};n(Oe,{default:()=>Bt});var Bt,xe=o(()=>{ke();Bt={template:Ce,props:{item:{required:!0}}}});var Se,$e=o(()=>{Se=`{% block heptacom_admin_open_auth_provider_jumpcloud_settings %}
    ...
    {% endblock %}
{% endblock %}
`});var Pe={};n(Pe,{default:()=>Xt});var Xt,Fe=o(()=>{$e();Xt={template:Se,props:{item:{required:!0}},data(){return{availableProperties:["firstName","lastName","email","timezone","locale","roles"]}},watch:{item(e){e.config.attributeMapping||(e.config.attributeMapping={})}}}});var Ue,Re=o(()=>{Ue=`{% block heptacom_admin_open_auth_provider_keycloak_settings %}
...
{% endblock %}
`});var Ne={};n(Ne,{default:()=>Yt});var Yt,Ee=o(()=>{He();Yt={template:je,props:{item:{required:!0}},watch:{item(e){e.config.scopes||(e.config.scopes=[])}}}});var Be,ze=o(()=>{Be=`{% block heptacom_admin_open_auth_provider_onelogin_settings %}
...
{% endblock %}
`});var Ke={};n(Ke,{default:()=>ei});var ei,Xe=o(()=>{ze();ei={template:Be,props:{item:{required:!0}},watch:{item(e){e.config.scopes||(e.config.scopes=[])}}}});var Ge,Je=o(()=>{Ge=`{% block sw_condition_value_content %}
