(()=>{var ct=Object.defineProperty;var o=(e,t)=>()=>(e&&(t=e(e=0)),t);var n=(e,t)=>{for(var i in t)ct(e,i,{get:t[i],enumerable:!0})};var k={};n(k,{default:()=>pt});var pt,C=o(()=>{pt={methods:{validateCurrentValue(e){let t=this.getURLInstance(e);return t?t.toString().replace(/([a-zA-Z0-9]+\:\/\/)+/,"").replace(t.host,this.unicodeUriFilter(t.host)):null}}}});var O=o(()=>{});var S,x=o(()=>{S=`{% block heptacom_admin_open_auth_user_confirm %}
...
`});var P={};n(P,{default:()=>ht});var fi,h,$,ht,F=o(()=>{O();x();({Component:fi,Context:h}=Shopware),$="HeptacomAdminOpenAuthConfirmState",ht={template:S,inject:["loginService","repositoryFactory"],props:{divider:{type:Boolean,default:!0}},data(){return{loading:!0,clients:[],waitingForConfirmation:!1,confirmationClient:null,popupsAreBlocked:null}},computed:{heptacomAdminOpenAuthClientsRepository(){return this.repositoryFactory.create("heptacom_admin_open_auth_client")},httpClient(){return this.heptacomAdminOpenAuthClientsRepository.httpClient},sectionDivider(){return this.divider?"bottom":""}},created(){this.createdComponent()},methods:{createdComponent(){this.loadClients()},loadClients(){this.loading=!0,this.clients=[],this.getConnectedClients().then(e=>{this.clients=e}).finally(()=>{this.loading=!1})},startAuthFlow(e){let t=this;this.waitingForConfirmation=!0,this.popupsAreBlocked=null,this.confirmationClient=e,localStorage.removeItem($),this.getConfirmRedirectUrl(e.id).then(i=>{let a=Math.floor((screen.width-600)/2),r=Math.floor((screen.height-600)/2),s=window.open(i,this.$t("heptacom-admin-open-auth-user-confirm-login.confirmWith",{clientName:e.name}),`location=0,status=0,width=600,height=600, top=${r}, left=${a}`),d=null,_=window.setTimeout(()=>{(!s||s.closed||typeof s.closed>"u")&&(t.popupsAreBlocked=!0,t.waitingForConfirmation=!1,d&&window.clearInterval(d))},1200);try{s.focus(),t.popupsAreBlocked=!1}catch{t.popupsAreBlocked=!0,t.waitingForConfirmation=!1,window.clearTimeout(_);return}d=window.setInterval(()=>{if(!this.waitingForConfirmation){window.clearInterval(d),window.clearTimeout(_),this.popupsAreBlocked=!1,s.close();return}if(s.closed){window.clearInterval(d),window.clearTimeout(_),this.popupsAreBlocked=!1,this.waitingForConfirmation=!1;let g=localStorage.getItem($);g&&this.verifyByState(JSON.parse(g).state)}},1e3)})},abortAuthFlow(){this.confirmationClient=null,this.waitingForConfirmation=!1},getConnectedClients(){let e=this.heptacomAdminOpenAuthClientsRepository.buildHeaders(h.api);return this.httpClient.get("/_admin/open-auth/client/list",{headers:e}).then(t=>t.data.data.filter(i=>i.connected))},getConfirmRedirectUrl(e){let t=this.heptacomAdminOpenAuthClientsRepository.buildHeaders(h.api);return this.httpClient.get(`/_admin/open-auth/${e}/confirm`,{headers:t}).then(i=>i.data.target)},verifyByState(e){this.httpClient.post("/oauth/token",{grant_type:"heptacom_admin_open_auth_one_time_token",client_id:"administration",scope:"user-verified",one_time_token:e},{baseURL:h.api.apiPath}).then(t=>{let i={...h.api};i.authToken.access=t.data.access_token;let a={...this.loginService.getBearerAuthentication(),access:i.authToken.access};this.loginService.setBearerAuthentication(a),this.$emit("confirm",i)})}}}});var L,q=o(()=>{L=`{% block heptacom_admin_open_auth_role_assignment_action_config %}
    ...
    ></sw-entity-multi-id-select>
{% endblock %}
`});var T={};n(T,{default:()=>bt});var bt,D=o(()=>{q();bt={template:L,inject:["repositoryFactory"],props:{client:{required:!0,type:Object},rule:{required:!0,type:Object}},computed:{aclRoleRepository(){return this.repositoryFactory.create("acl_role")}}}});var H,I=o(()=>{H=`{% block heptacom_admin_open_auth_client_rule_container %}
    <div>
...
{% endblock %}
`});var se={};n(se,{default:()=>Mt});var Ft,Rt,Ut,v,Mt,de=o(()=>{ne();re();({Context:Ft,Data:Rt,Mixin:Ut}=Shopware),{Criteria:v}=Rt,Mt={template:le,inject:["acl","repositoryFactory"],mixins:[Ut.getByName("listing")],data(){return{isLoading:!0,items:null,columns:[{property:"active",label:this.$t("heptacom-admin-open-auth-client.pages.listing.columns.active"),allowResize:!1,width:"50px"},{property:"name",label:this.$t("heptacom-admin-open-auth-client.pages.listing.columns.name"),routerLink:"heptacom.admin.open.auth.client.edit"},{property:"provider",label:this.$t("heptacom-admin-open-auth-client.pages.listing.columns.provider")},{property:"userKeys.length",label:this.$t("heptacom-admin-open-auth-client.pages.listing.columns.users"),width:"100px"},{property:"createdAt",label:this.$t("heptacom-admin-open-auth-client.pages.listing.columns.createdAt"),width:"200px"}]}},created(){this.getList()},computed:{clientRepository(){return this.repositoryFactory.create("heptacom_admin_open_auth_client")},clientCriteria(){let e=new v,t=this.getMainListingParams();return e.addAssociation("userKeys"),e.setLimit(t.limit),e.setPage(t.page),e.addSorting(v.sort(t.sortBy||"name",t.sortDirection||"ASC")),t.term&&t.term.length&&e.addFilter(v.contains("name",t.term)),e},dateFilter(){return Shopware.Filter.getByName("date")}},methods:{getList(){return this.loadData()},loadData(){this.isLoading=!0,this.loadClients().then(()=>{this.isLoading=!1})},loadClients(){return this.items=null,this.clientRepository.search(this.clientCriteria,Ft.api).then(e=>{this.items=e})},getLoginColor(e){return e.active?e.login?"#00cc00":"#cc0000":"#333333"},getConnectColor(e){return e.active?e.connect?"#00cc00":"#cc0000":"#333333"}}}});var ge,_e=o(()=>{ge=`{% block heptacom_admin_open_auth_provider_cidaas_settings %}
...
{% endblock %}
`});var fe={};n(fe,{default:()=>jt});var jt,ve=o(()=>{_e();jt={template:ge,props:{item:{required:!0}},watch:{item(e){e.config.scopes||(e.config.scopes=[])}}}});var we,be=o(()=>{we=`{% block heptacom_admin_open_auth_client_google_cloud_settings %}
...
{% endblock %}
`});var Ae={};n(Ae,{default:()=>Et});var Et,ye=o(()=>{be();Et={template:we,props:{item:{required:!0}},watch:{item(e){e.config.scopes||(e.config.scopes=[])}}}});var Ce,ke=o(()=>{Ce=`{% block heptacom_admin_open_auth_provider_jira_settings %}
...
{% endblock %}
`});var Oe={};n(Oe,{default:()=>zt});var zt,xe=o(()=>{ke();zt={template:Ce,props:{item:{required:!0}}}});var $e,Se=o(()=>{$e=`{% block heptacom_admin_open_auth_provider_jumpcloud_settings %}
    ...
    {% endblock %}
{% endblock %}
`});var Pe={};n(Pe,{default:()=>Xt});var Xt,Fe=o(()=>{Se();Xt={template:$e,props:{item:{required:!0}},data(){return{availableProperties:["firstName","lastName","email","timezone","locale","roles"]}},watch:{item(e){e.config.attributeMapping||(e.config.attributeMapping={})}}}});var Ue,Re=o(()=>{Ue=`{% block heptacom_admin_open_auth_provider_keycloak_settings %}
...
{% endblock %}
`});var Me={};n(Me,{default:()=>Gt});var Gt,qe=o(()=>{Re();Gt={template:Ue,props:{item:{required:!0}},data(){return{jsonPlaceholder:JSON.stringify({realm:"master","auth-server-url":"https://keycloak.my-company.com/auth/","ssl-required":"external",resource:"my-client",credentials:{secret:"abcdefghijgklmnopqrstuvwxyz"},"confidential-port":0},null,"	")}},watch:{item(e){e.config.scopes||(e.config.scopes=[])}}}});var Te,Le=o(()=>{Te=`{% block heptacom_admin_open_auth_provider_microsoft_azure_oidc_settings %}
...
{% endblock %}
`});var De={};n(De,{default:()=>Zt});var Zt,Ie=o(()=>{Le();Zt={template:Te,props:{item:{required:!0}},watch:{item(e){e.config.scopes||(e.config.scopes=[])}}}});var je,He=o(()=>{je=`{% block heptacom_admin_open_auth_provider_okta_settings %}
...
{% endblock %}
`});var Ne={};n(Ne,{default:()=>Yt});var Yt,Ee=o(()=>{He();Yt={template:je,props:{item:{required:!0}},watch:{item(e){e.config.scopes||(e.config.scopes=[])}}}});var ze,Be=o(()=>{ze=`{% block heptacom_admin_open_auth_provider_onelogin_settings %}
...
{% endblock %}
`});var Ke={};n(Ke,{default:()=>ei});var ei,Xe=o(()=>{Be();ei={template:ze,props:{item:{required:!0}},watch:{item(e){e.config.scopes||(e.config.scopes=[])}}}});var Ge,Je=o(()=>{Ge=`{% block sw_condition_value_content %}
...
{% endblock %}
`});var We=o(()=>{});var Ze={};n(Ze,{default:()=>ai});var ii,oi,ai,Qe=o(()=>{Je();We();({Component:ii}=Shopware),{mapPropertyErrors:oi}=ii.getComponentHelper(),ai={template:Ge,computed:{requestUrl:{get(){return this.ensureValueExist(),this.condition.value.requestUrl||null},set(e){this.ensureValueExist(),this.condition.value={...this.condition.value,requestUrl:e}}},jmesPathExpression:{get(){return this.ensureValueExist(),this.condition.value.jmesPathExpression||null},set(e){this.ensureValueExist(),this.condition.value={...this.condition.value,jmesPathExpression:e}}},...oi("condition",["value.requestUrl","value.jmesPathExpression"]),currentError(){return this.conditionValueRequestUrlError||this.conditionValueJmesPathExpressionError}}}});var Ve,Ye=o(()=>{Ve=`{% block heptacom_admin_open_auth_provider_open_id_connect_settings %}
...
{% endblock %}
`});var et={};n(et,{default:()=>ri});var ri,tt=o(()=>{Ye();ri={template:Ve,props:{item:{required:!0}},watch:{item(e){e.config.scopes||(e.config.scopes=[])}}}});var ot,it=o(()=>{ot=`{% block heptacom_admin_open_auth_provider_saml2_settings %}
    <div>
...
{% endblock %}
`;var{Component:ft}=Shopware;ft.override("sw-verify-user-modal",{template:M,inject:["systemConfigApiService"],data(){return{denyPasswordLogin:!1}},created(){this.systemConfigApiService.getValues("KskHeptacomAdminOpenAuth.config").then(e=>{this.denyPasswordLogin=e["KskHeptacomAdminOpenAuth.config.denyPasswordLogin"]})},methods:{onCloseConfirmPasswordModal(){return this.$refs.heptacomAdminOpenAuthUserConfirmLogin.abortAuthFlow(),this.$super("onCloseConfirmPasswordModal")},heptacomAdminOpenAuthUserConfirm(e){this.$emit("verified",e)}}});Shopware.Service("privileges").addPrivilegeMappingEntry({category:"permissions",parent:"settings",key:"heptacom_admin_open_auth_client",roles:{viewer:{privileges:["heptacom_admin_open_auth_client:read","heptacom_admin_open_auth_user_key:read","heptacom_admin_open_auth_client_rule:read","heptacom_admin_open_auth_client_rule_condition:read"],dependencies:[]},editor:{privileges:["heptacom_admin_open_auth_client:update","heptacom_admin_open_auth_client_rule:create","heptacom_admin_open_auth_client_rule:update","heptacom_admin_open_auth_client_rule:delete","heptacom_admin_open_auth_client_rule_condition:create","heptacom_admin_open_auth_client_rule_condition:update","heptacom_admin_open_auth_client_rule_condition:delete"],dependencies:["heptacom_admin_open_auth_client.viewer"]},creator:{privileges:["heptacom_admin_open_auth_client:create"],dependencies:["heptacom_admin_open_auth_client.editor"]},deleter:{privileges:["heptacom_admin_open_auth_client:delete"],dependencies:["heptacom_admin_open_auth_client.viewer"]}}});var{Component:c,Module:qt}=Shopware;c.register("heptacom-admin-open-auth-role-assignment-action-config",()=>Promise.resolve().then(()=>(D(),T)));c.register("heptacom-admin-open-auth-client-rule-container",()=>Promise.resolve().then(()=>(N(),j)));c.register("heptacom-admin-open-auth-client-rule-item",()=>Promise.resolve().then(()=>(X(),K)));c.register("heptacom-admin-open-auth-client-create-page",()=>Promise.resolve().then(()=>(Q(),Z)));c.register("heptacom-admin-open-auth-client-edit-page",()=>Promise.resolve().then(()=>(ae(),oe)));c.register("heptacom-admin-open-auth-client-listing-page",()=>Promise.resolve().then(()=>(de(),se)));qt.register("heptacom-admin-open-auth-client",{type:"plugin",name:"heptacom-admin-open-auth-client.module.name",title:"heptacom-admin-open-auth-client.module.title",description:"heptacom-admin-open-auth-client.module.description",color:"#FFC2A2",icon:"regular-sign-in",routes:{create:{component:"heptacom-admin-open-auth-client-create-page",path:"create",meta:{parentPath:"heptacom.admin.open.auth.client.settings",privilege:"heptacom_admin_open_auth_client.creator"}},edit:{component:"heptacom-admin-open-auth-client-edit-page",path:"edit/:id",meta:{parentPath:"heptacom.admin.open.auth.client.settings",privilege:"heptacom_admin_open_auth_client.editor"},props:{default(e){return{clientId:e.params.id}}}},settings:{component:"heptacom-admin-open-auth-client-listing-page",path:"settings",meta:{parentPath:"sw.settings.index",privilege:"heptacom_admin_open_auth_client.viewer"}}},settingsItem:[{to:"heptacom.admin.open.auth.client.settings",group:"system",icon:"regular-sign-in",privilege:"heptacom_admin_open_auth_client.viewer"}]});var ce=e=>(e.addCondition("heptacomAdminOpenAuthMicrosoftAzureOidcGroups",{component:"sw-condition-generic",label:"heptacomAdminOpenAuthClient.providerFields.microsoft_azure_oidc.condition.rule.groupIds",scopes:["microsoft_azure_oidc"],group:"user"}),e);var pe=e=>(e.addCondition("heptacomAdminOpenAuthAuthenticatedRequest",{component:"heptacom-admin-open-auth-condition-authenticated-request",label:"heptacomAdminOpenAuthClient.providerFields.open_id_connect.condition.rule.authenticatedRequest",scopes:["open_id_connect","cidaas","google_cloud","keycloak","microsoft_azure_oidc","okta","onelogin"],group:"user"}),e);var me=e=>(e.addCondition("heptacomAdminOpenAuthSaml2Role",{component:"sw-condition-generic",label:"heptacomAdminOpenAuthClient.providerFields.saml2.condition.rule.roles",scopes:["saml2"],group:"user"}),e);var he=`{% block heptacom_admin_open_auth_client_edit_page_content_base_settings_inner_store_user_token %}
...
{% endblock %}
`;var{Component:It}=Shopware;It.override("heptacom-admin-open-auth-client-edit-page",{template:ue,data(){return{selectedMappingTemplate:null,availableProperties:["firstName","lastName","email","timezone","locale"],attributeMappingTemplates:{friendlyNames:{firstName:"givenName",lastName:"surName",email:"emailAddress"},x500:{firstName:"urn:oid:2.5.4.42",lastName:"urn:oid:2.5.4.4",email:"urn:oid:1.2.840.113549.1.9.1"},entraId:{firstName:"http://schemas.xmlsoap.org/ws/2005/05/identity/claims/givenname",lastName:"http://schemas.xmlsoap.org/ws/2005/05/identity/claims/surname",email:"http://schemas.xmlsoap.org/ws/2005/05/identity/claims/emailaddress"}}}},watch:{item(e){e&&e.provider==="saml2"&&(e.config.attributeMapping||(e.config.attributeMapping={}))}},methods:{onApplyMappingTemplate(e){let t=this.attributeMappingTemplates[e];this.item.config.attributeMapping=Object.assign(this.item.config.attributeMapping,t)}}});var{Application:b,Component:l}=Shopware;l.register("heptacom-admin-open-auth-provider-cidaas-settings",()=>Promise.resolve().then(()=>(ve(),fe)));l.register("heptacom-admin-open-auth-provider-google-cloud-settings",()=>Promise.resolve().then(()=>(ye(),Ae)));l.register("heptacom-admin-open-auth-provider-jira-settings",()=>Promise.resolve().then(()=>(xe(),Oe)));l.register("heptacom-admin-open-auth-provider-jumpcloud-settings",()=>Promise.resolve().then(()=>(Fe(),Pe)));l.register("heptacom-admin-open-auth-provider-keycloak-settings",()=>Promise.resolve().then(()=>(qe(),Me)));l.register("heptacom-admin-open-auth-provider-microsoft-azure-oidc-settings",()=>Promise.resolve().then(()=>(Ie(),De)));b.addServiceProviderDecorator("heptacomOauthRuleDataProvider",ce);l.register("heptacom-admin-open-auth-provider-okta-settings",()=>Promise.resolve().then(()=>(Ee(),Ne)));l.register("heptacom-admin-open-auth-provider-onelogin-settings",()=>Promise.resolve().then(()=>(Xe(),Ke)));l.extend("heptacom-admin-open-auth-condition-authenticated-request","sw-condition-base",()=>Promise.resolve().then(()=>(Qe(),Ze)));l.register("heptacom-admin-open-auth-provider-open-id-connect-settings",()=>Promise.resolve().then(()=>(tt(),et)));b.addServiceProviderDecorator("heptacomOauthRuleDataProvider",pe);l.register("heptacom-admin-open-auth-provider-saml2-settings",()=>Promise.resolve().then(()=>(nt(),at)));b.addServiceProviderDecorator("heptacomOauthRuleDataProvider",me);var{Classes:di}=Shopware,{ApiService:m}=di,w=class extends m{constructor(t,i,a="heptacom_admin_open_auth_provider"){super(t,i,a)}list(){let t=this.getBasicHeaders();return this.httpClient.get(`_action/${this.getApiBasePath()}/list`,{headers:t}).then(i=>m.handleResponse(i))}factorize(t){let i=this.getBasicHeaders();return this.httpClient.post(`_action/${this.getApiBasePath()}/factorize`,{provider_key:t},{headers:i}).then(a=>m.handleResponse(a))}getRedirectUri(t){let i=this.getBasicHeaders();return this.httpClient.post(`_action/${this.getApiBasePath()}/client-redirect-url`,{client_id:t},{headers:i}).then(a=>m.handleResponse(a))}getMetadataUri(t){let i=this.getBasicHeaders();return this.httpClient.post(`_action/${this.getApiBasePath()}/client-metadata-url`,{client_id:t},{headers:i}).then(a=>m.handleResponse(a))}},rt=w;var{Classes:ci}=Shopware,{ApiService:lt}=ci,A=class extends lt{constructor(t,i,a="heptacom_admin_open_auth_rule_actions"){super(t,i,a)}list(){let t=this.getBasicHeaders();return this.httpClient.get(`_action/${this.getApiBasePath()}/list`,{headers:t}).then(i=>lt.handleResponse(i))}},st=A;var u=class{$store={};operators={lowerThanEquals:{identifier:"<=",label:"global.sw-condition.operator.lowerThanEquals"},equals:{identifier:"=",label:"global.sw-condition.operator.equals"},greaterThanEquals:{identifier:">=",label:"global.sw-condition.operator.greaterThanEquals"},notEquals:{identifier:"!=",label:"global.sw-condition.operator.notEquals"},greaterThan:{identifier:">",label:"global.sw-condition.operator.greaterThan"},lowerThan:{identifier:"<",label:"global.sw-condition.operator.lowerThan"},isOneOf:{identifier:"=",label:"global.sw-condition.operator.isOneOf"},isNoneOf:{identifier:"!=",label:"global.sw-condition.operator.isNoneOf"},gross:{identifier:!1,label:"global.sw-condition.operator.gross"},net:{identifier:!0,label:"global.sw-condition.operator.net"},empty:{identifier:"empty",label:"global.sw-condition.operator.empty"}};operatorSets={defaultSet:[this.operators.equals,this.operators.notEquals,this.operators.greaterThanEquals,this.operators.lowerThanEquals],singleStore:[this.operators.equals,this.operators.notEquals],multiStore:[this.operators.isOneOf,this.operators.isNoneOf],string:[this.operators.equals,this.operators.notEquals],bool:[this.operators.equals],number:[this.operators.equals,this.operators.greaterThan,this.operators.greaterThanEquals,this.operators.lowerThan,this.operators.lowerThanEquals,this.operators.notEquals],date:[this.operators.equals,this.operators.greaterThan,this.operators.greaterThanEquals,this.operators.lowerThan,this.operators.lowerThanEquals,this.operators.notEquals],isNet:[this.operators.gross,this.operators.net],empty:[this.operators.empty],zipCode:[this.operators.greaterThan,this.operators.greaterThanEquals,this.operators.lowerThan,this.operators.lowerThanEquals]};groups={general:{id:"general",name:"sw-settings-rule.detail.groups.general"},user:{id:"user",name:"heptacom-admin-open-auth.condition.group.user"}};getByType(t){if(!t)return this.getByType("placeholder");if(t==="scriptRule"){let i=this.getConditions().filter(a=>a.type==="scriptRule").shift();if(i)return i}return this.$store[t]}getOperatorSet(t){return this.operatorSets[t]}addEmptyOperatorToOperatorSet(t){return t.concat(this.operatorSets.empty)}getOperatorSetByComponent(t){let i=t.config.componentName,a=t.type;return i==="sw-single-select"?this.operatorSets.singleStore:i==="sw-multi-select"?this.operatorSets.multiStore:a==="bool"?this.operatorSets.bool:a==="text"?this.operatorSets.string:a==="int"?this.operatorSets.number:this.operatorSets.defaultSet}getOperatorOptionsByIdentifiers(t,i=!1){return t.map(a=>{let r=Object.entries(this.operators).find(([s,d])=>i&&["equals","notEquals"].includes(s)||!i&&["isOneOf","isNoneOf"].includes(s)?!1:a===d.identifier);return r?r.pop():{identifier:a,label:`global.sw-condition.operator.${a}`}})}getByGroup(t){let i=Object.values(this.$store),a=[];return i.forEach(r=>{r.group===t&&a.push(r)}),a}getGroups(){return this.groups}upsertGroup(t,i){this.groups[t]={...this.groups[t],...i}}removeGroup(t){delete this.groups[t]}addCondition(t,i){i.type=t,this.$store[i.scriptId??t]=i}getConditions(t=null){let i=Object.values(this.$store);return t!==null&&(i=i.filter(a=>t.some(r=>a.scopes.indexOf(r)!==-1))),i}getComponentByCondition(t){if(this.isAndContainer(t))return"sw-condition-and-container";if(this.isOrContainer(t))return"sw-condition-or-container";if(this.isAllLineItemsContainer(t))return"sw-condition-all-line-items-container";if(!t.type)return"sw-condition-base";let i=this.getByType(t.type);return typeof i>"u"||!i.component?"sw-condition-not-found":i.component}getAndContainerData(){return{type:"andContainer",value:{}}}isAndContainer(t){return t.type==="andContainer"}getOrContainerData(){return{type:"orContainer",value:{}}}isOrContainer(t){return t.type==="orContainer"}getPlaceholderData(){return{type:null,value:{}}}isAllLineItemsContainer(t){return t.type==="allLineItemsContainer"}};var dt=e=>(e.addCondition("alwaysValid",{component:"sw-condition-is-always-valid",label:"global.sw-condition.condition.alwaysValidRule",scopes:["global"],group:"general"}),e.addCondition("dateRange",{component:"sw-condition-date-range",label:"global.sw-condition.condition.dateRangeRule.label",scopes:["global"],group:"general"}),e.addCondition("timeRange",{component:"sw-condition-time-range",label:"global.sw-condition.condition.timeRangeRule",scopes:["global"],group:"general"}),e.addCondition("heptacomAdminOpenAuthEmail",{component:"sw-condition-generic",label:"heptacom-admin-open-auth.condition.rule.email",scopes:["global"],group:"user"}),e.addCondition("heptacomAdminOpenAuthTimeZone",{component:"sw-condition-generic",label:"heptacom-admin-open-auth.condition.rule.timeZone",scopes:["jira","jumpcloud","keycloak","okta","open_id_connect","saml2"],group:"user"}),e.addCondition("heptacomAdminOpenAuthLocale",{component:"sw-condition-generic",label:"heptacom-admin-open-auth.condition.rule.locale",scopes:["google_cloud","jumpcloud","keycloak","okta","onelogin","open_id_connect","saml2"],group:"user"}),e.addCondition("heptacomAdminOpenAuthPrimaryKey",{component:"sw-condition-generic",label:"heptacom-admin-open-auth.condition.rule.primaryKey",scopes:["global"],group:"user"}),e);var{Application:y}=Shopware;y.addServiceProvider("HeptacomAdminOpenAuthProviderApiService",e=>{let t=y.getContainer("init");return new rt(t.httpClient,e.loginService)}).addServiceProvider("HeptacomAdminOpenAuthRuleActionsApiService",e=>{let t=y.getContainer("init");return new st(t.httpClient,e.loginService)}).addServiceProvider("heptacomOauthRuleDataProvider",()=>new u).addServiceProviderDecorator("heptacomOauthRuleDataProvider",dt);})();
