...
`});var ye={};a(ye,{default:()=>Ht});var Ht,ke=o(()=>{we();Ht={template:Ae,props:{item:{required:!0}}}});var xe,Ce=o(()=>{xe=`{% block heptacom_admin_open_auth_provider_jumpcloud_settings %}
    ...
    {% endblock %}
{% endblock %}
`});var Oe={};a(Oe,{default:()=>Et});var Et,Se=o(()=>{Ce();Et={template:xe,props:{item:{required:!0}},data(){return{availableProperties:["firstName","lastName","email","timezone","locale","roles"]}},watch:{item(e){e.config.attributeMapping||(e.config.attributeMapping={})}}}});var Pe,$e=o(()=>{Pe=`{% block heptacom_admin_open_auth_provider_keycloak_settings %}
...
{% endblock %}
`});var Ie={};a(Ie,{default:()=>Jt});var Jt,He=o(()=>{De();Jt={template:Te,props:{item:{required:!0}},watch:{item(e){e.config.scopes||(e.config.scopes=[])}}}});var Ee,Ne=o(()=>{Ee=`{% block heptacom_admin_open_auth_provider_onelogin_settings %}
...
{% endblock %}
`});var je={};a(je,{default:()=>Vt});var Vt,ze=o(()=>{Ne();Vt={template:Ee,props:{item:{required:!0}},watch:{item(e){e.config.scopes||(e.config.scopes=[])}}}});var Ke,Be=o(()=>{Ke=`{% block sw_condition_value_content %}
...
`;var{Component:Rt}=Shopware;Rt.override("heptacom-admin-open-auth-client-edit-page",{template:pe,data(){return{availableProperties:["firstName","lastName","email","timezone","locale"]}},watch:{item(e){e&&e.provider==="jumpcloud"&&(e.config.attributeMapping||(e.config.attributeMapping={}))}}});var ce=`{% block heptacom_admin_open_auth_client_edit_page_content_base_settings_inner_store_user_token %}
